...
namespace Duality.Plugins.Pathfindax.Components
{
	...
	{
		/// <summary>
		/// The id of the pathfinder. This is used by the <see cref="PathfinderProxy{TSourceNodeNetwork}"/> to get the correct pathfinder if there are multiple pathfinders in the <see cref="Scene"/>
		/// </summary>
