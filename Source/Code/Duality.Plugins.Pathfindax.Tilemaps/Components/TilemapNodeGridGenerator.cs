	...
	public class TilemapNodeGridGenerator : Component, ISourceNodeNetworkProvider<SourceNodeGrid>
	{
		...
		public SourceNodeGrid GenerateGrid2D()
		{
			if (_sourceNodeGrid == null)
			{
				...
				_sourceNodeGrid = sourceNodeGridFactory.GeneratePreFilledArray(baseTilemap.Size.X, baseTilemap.Size.Y, new Vector2(baseTilemap.Tileset.Res.TileSize.X, baseTilemap.Tileset.Res.TileSize.Y), GenerateNodeGridConnections.None, 5, new Vector2(offset.X, offset.Y));
